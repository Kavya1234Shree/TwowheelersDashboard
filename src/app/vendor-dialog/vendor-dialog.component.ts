...
//  this.PubNub = pubnub
  ...
  ngOnInit() {
    ...
    let resp = this.http.get("http://172.105.56.231:2390/api/vendor-reg/id?vendor_uuid="+this.vendor_uuid);
    resp.subscribe((data)=>{
    this.user=data;
   ...
   this.GST_certificate='http://172.105.56.231:2390/'+data['GST_certificate']
