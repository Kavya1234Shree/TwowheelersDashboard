...
rotate5() {
  ...
  constructor( private http: HttpClient,private router:Router,route :ActivatedRoute,public dialogRef: MatDialogRef<DeactivateDialogComponent>,@Inject(MAT_DIALOG_DATA) public data) 
     {
      this.driver_uuid=data;  
   }

  ngOnInit() 
  { 
    let resp = this.http.get("http://172.105.56.231:2390/api/deactivate/id?driver_uuid="+this.driver_uuid);
...
// onSubmit(driver_name,email,phone,driver_address,driver_city,driver_state,driver_zip,bank_name,account_no,IFSC_code,type_of_account,accountholder_name,vehicle_number,active)
// {
//   this.phone=phone;
...
//                   this.closeModal()
//                   console.log('profile', this.profile_photo) ;
