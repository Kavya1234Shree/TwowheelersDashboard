...
export class FourwheelerdriverComponent implements OnInit {
 ...
 totalRec : number;
  ...
  ngOnInit() {
    const resp = this.httpClient.get('http://172.105.56.231:2390/api/driverfour');
...
deleteRow(phone){
 ...
 let resp=this.httpClient.get('http://172.105.56.231:2390/api/driverfour/delete?phone='+phone);
