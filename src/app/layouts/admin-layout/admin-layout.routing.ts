import { PriceKmComponent } from './../../price-km/price-km.component';

import { OtpGetComponent } from './../../otp-get/otp-get.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    // {path: 'otp',  component: BookingotpComponent,canActivate: [AuthGuard]},
    ...
    {path:'otp-get',component:OtpGetComponent,canActivate: [AuthGuard]},
    {path:'price-km',component:PriceKmComponent,canActivate: [AuthGuard]},
