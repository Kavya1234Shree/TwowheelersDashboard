...
public driver_online: any;
 ...
 pubnub = new PubNubAngular();
  ...
  pubnub.subscribe({
     ...
     ////////online//////////
    let resp= this.http.get("http://172.105.56.231:2390/api/driver-position/driver-twoonline")
    resp.subscribe((data: any)=>{
       console.log(data) ;
 this.driver_online= data.count ;
 console.log(this.driver_online);
      ...
      ////////offline//////////
      let response= this.http.get("http://172.105.56.231:2390/api/driver-position/driver-twooffline")
 ...
 ////////two-wheel-registered-driv//////////
        let respons= this.http.get("http://172.105.56.231:2390/api/driver-registration/driver-two")
...
// let respon= this.http.get("http://172.105.56.231:2390/api/driver-registration/driver-four")
...
let respo= this.http.get("http://172.105.56.231:2390/api/transaction/picked-two")
...
let res= this.http.get("http://172.105.56.231:2390/api/transaction/accept-two")
