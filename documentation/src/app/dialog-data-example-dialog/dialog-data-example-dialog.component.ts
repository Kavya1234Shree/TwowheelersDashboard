...
if(event.target.checked)
{
  ...
  ngOnInit() {
   let resp = this.http.get<any>("https://apis.zeiger.tech/api/driverfour-owner/phone?phone="+this.phone);
  ...
  onDriver(driver_name,email,phone,driver_address,driver_city,driver_state,driver_zip,alternate_contact_num,
   ...
   body_type,will_accept_to_work_for_below_category,bank_name,account_no,IFSC_code,type_of_account,owner_name,owner_phone,address1,city,state,zip,active){
      ...
      //  }
                  ...
                  fd.append('badge_val',this.badge_val);
                  ...
                  this.closeModal()
                      this.http.post('https://cors-anywhere.herokuapp.com/https://zeiger.tech/api/1.0/driver-owner',fd,{})

                      .subscribe((data:any)=>{
                        
                     console.log('posting data owner',data);
                      ...
                      this.router.navigate(['/dashboard']);
                       ...
                       console.log("eeerererrrer",error)
