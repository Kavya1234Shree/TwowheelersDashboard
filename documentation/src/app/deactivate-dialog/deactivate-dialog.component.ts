...
// will_accept_to_work_for_below_category:string='';
namec:string='';
...
if(event.target.checked)
{
  ...
  ngOnInit() {
   let resp = this.http.get("https://apis.zeiger.tech/api/deactivate/id?driver_uuid="+this.driver_uuid);
  ...
  //  this.contact_numbera=data['contact_numbera']
   this.category=data['category']
  //  this.contact_numberb=data['contact_numberb']
  ...
  this.will_accept_to_work_for_below_category=data['will_accept_to_work_for_below_category']
   ...
   console.log('data drv',this.user);
